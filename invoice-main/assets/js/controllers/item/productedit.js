angular.module('posApp')
  .controller('ProdeditCtrl', function($scope,$state,Upload, $mdDialog,verifyDelete,$stateParams,$mdToast,$http) {
    ...
    $http.post('/products/productedit',{id:$stateParams.id}).then(function (res) {
      ...
      res.data.product.prices = [{'salesrate':res.data.product.salesrate,'purchaserate':res.data.product.purchaserate,'mrp':'','variant':''}]
  ...
  $scope.addUom = function(ev) {
    ...
    .then(function(uom) {
      console.log(uom)
      $scope.error('Uom Added Successfully')
      $scope.uoms = uom;;
    });
  };
  function adduomController($scope, $mdDialog) {
    ...
    $scope.cancel = function() {
      ...
      .then(function(uom) {
        console.log(uom)
        $scope.error('Category Added Successfully')
      });
    };
    function addcategoryController($scope, $mdDialog) {
      ...
      $scope.addcategory=function () {
          $scope.data ='';
          $http.post('/collection/addcollection', {collectiontitle: $scope.collection.collectiontitle, collectioncode: $scope.collection.collectioncode,description:$scope.collection.description}).then(function (res) {
            console.log(res)
