angular.module('posApp')
  .controller('newsalereturnCtrl', function($scope,$http,$mdDialog,verifyDelete,$timeout,$mdToast,$state,$filter,hotkeys) {
    $scope.selectedcustomer='';
    $scope.selectedbill='';
    $scope.billdate = new Date(Date.now());
    $http.post('/salereturn/getid').then(function (res) {
      console.log(res)
      ...
      $scope.checkid = (id) => {
        if (id == undefined) {
          ...
          return $http.post('/salereturn/checkid', { id: id }).then(function (res) {
            console.log(res)
          }).catch((err) => {
            console.log(err)
  ...
  $mdDialog.hide();
    ...
    $scope.addbill=function () {
      ...
      $http.post('/salereturn/addbill',{
        ...
        console.log(res)
        $state.go('singlesalereturn',{sid:res.data.return.returnid});
