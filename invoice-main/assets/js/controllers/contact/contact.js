angular.module('posApp')
  .controller('AddscontactCtrl', function ($scope, $http,$state, $location, $mdDialog, verifyDelete) {
    ...
    //This self invoked function automaticaly calls to get the country.json file to show in country dropdown
    (()=>{
    ...
    //this function is used to copy the billing address data to the shipping address fields
    $scope.copyAddress=()=>{
      $scope.shippingAddress = angular.copy($scope.address)
      console.log($scope.shippingAddress)
    }
    //this is to add the contact details in the database request
