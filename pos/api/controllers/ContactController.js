...
module.exports = {
	addcontact:(req,res)=>{
		Contact.create({type:req.param('type'),pannumber:req.param('pannumber'),taxtype:req.param('taxtype'),salutation:req.param('salutation'),firstname:req.param('firstname'),lastname:req.param('lastname'),company:req.param('company'),email:req.param('email'),phonenumber:req.param('phonenumber'),
