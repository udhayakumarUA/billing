angular.module('posApp')
  .controller('estimateCtrl', function ($scope, $mdDialog, $http, $stateParams, $location, $timeout, $state, $mdToast,hotkeys) {
    ...
    //getting estimate ID
      ...
      $http.post('/estimate/getid').then(function (res) {
        ...
        $scope.estimateid = 'EST-' + value.padStart(7, 0);
