angular.module('posApp')
  .controller('SinglecontactCtrl', function ($scope, $stateParams, $location, $http, $mdDialog, verifyDelete,$filter ) {
    ...
    $scope.getreportvendor = function () {
      var date = $filter('date')($scope.startdate2, 'yyyy-MM-dd');
      var date1 = $filter('date')($scope.enddate2, 'yyyy-MM-dd');
      var id = $scope.contact.id;
